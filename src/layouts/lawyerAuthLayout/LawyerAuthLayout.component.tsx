...
import { style } from './LawyerAuthLayout.style'
import { LawyerAuthLayoutProps } from './LawyerAuthLayout.props'
import LoginForm from '@/components/_form/loginForm/LoginForm.component'

export default function LawyerAuthLayout({ children }: LawyerAuthLayoutProps) {
